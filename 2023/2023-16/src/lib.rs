            ...
            for col in 0..cols {
                for j in 0..3 {
                    if i == 0 && j == 1 {
                        ...
                        {
                            string +=
                            match (from & Dir::Up as u8 != 0, to & Dir::Up as u8 != 0) {
                                (true,true) => "⇅", 
                                (true,false) => "↓", 
                                (false,true) => "↑", 
                                _ => " "
                        ...
                        {
                            string +=
                            match (from & Dir::Down as u8 != 0, to & Dir::Down as u8 != 0) {
                                (true,true) => "⇅", 
                                (true,false) => "↑", 
                                (false,true) => "↓", 
                                _ => " "
                        ...
                        {
                            string +=
                            match (from & Dir::Left as u8 != 0, to & Dir::Left as u8 != 0) {
                                (true,true) => "⇄", 
                                (true,false) => "→", 
                                (false,true) => "←", 
                                _ => " "
...
pub fn add(rays: &mut Vec<(i32,i32,Dir)>, history: &mut Vec<(i32,i32,Dir)>, item: (i32,i32,Dir)) {
...
pub fn process(map: &mut Grid<(Cell, u8, u8)>) {
    let mut rays = Vec::new();
    let mut history = Vec::new();
    //    1
    // 2     8
    //    4
    add(&mut rays, &mut history, (0, 0, Dir::Left));
