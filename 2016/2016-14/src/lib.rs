...
pub mod part1 {
    ...
    pub fn get_duplicate_num(md5: &mut HashMap<u64 ,(String, Vec<u64>, Vec<u64>)>, string: String, index: &u64) -> (String, Vec<u64>, Vec<u64>) {
...
pub mod part2 {
    ...
    pub fn get_duplicate_num(md5: &mut HashMap<u64 ,(String, Vec<u64>, Vec<u64>)>, string: String, index: &u64) -> (String, Vec<u64>, Vec<u64>) {
        md5.entry(*index).or_insert_with(|| 
            {
                let data = format!("{}{}", string, *index);
                let mut hash = format!("{:x}", md5::compute(&data));
                for _ in 0..2016 {
