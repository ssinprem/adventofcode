...
fn test_display_non_rotate() {
    ...
    assert_eq!(
        display(&transform(&pattern, Transform::Non)),
        "
#..
#..
##.
...
fn test_display_rotate_left() {
    ...
    assert_eq!(
        display(&transform(&pattern, Transform::RotLeft)),
        "
...
..#
###
...
fn test_display_rotate_right() {
    ...
    assert_eq!(
        display(&transform(&pattern, Transform::RotRight)),
        "
###
#..
...
...
fn test_display_rotate_haft() {
    ...
    assert_eq!(
        display(&transform(&pattern, Transform::RotHalf)),
        "
.##
..#
..#
...
fn test_display_rotate_flip_h() {
    ...
    assert_eq!(
        display(&transform(&pattern, Transform::FlipHor)),
        "
##.
#..
#..
...
fn test_display_rotate_flip_v() {
    ...
    assert_eq!(
        display(&transform(&pattern, Transform::FlipVir)),
        "
..#
..#
.##
...
fn test_display_rotate_flip_i() {
    ...
    assert_eq!(
        display(&transform(&pattern, Transform::FlipInc)),
        "
...
#..
###
...
fn test_display_rotate_flip_d() {
    ...
    assert_eq!(
        display(&transform(&pattern, Transform::FlipDec)),
        "
###
..#
...
...
"
    ...
    let result = put_yard(
        new_map.clone(),
        &transform(&pattern, Transform::RotLeft),
        1,
        1,
    );
    assert!(result.is_err());
    let result = put_yard(
        new_map.clone(),
        &transform(&pattern, Transform::RotRight),
        1,
        1,
    );
    assert!(result.is_err());
    let result = put_yard(
        new_map.clone(),
        &transform(&pattern, Transform::RotHalf),
        1,
        1,
    );
    assert!(result.is_ok());
